...
Gem::Specification.new do |spec|
  ...
  spec.summary     = "A modern CMS engine for Ruby on Rails"
  spec.description = "PostnHost is a mountable Rails engine that provides a full-featured CMS with multilingual support, AI-powered translations, and a built-in admin interface."
  spec.license     = "MIT"
