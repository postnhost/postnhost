  ...
  module Translation
    class ArticleVariantTranslator < BaseService
      ...
      def translate_schema_headline
        ...
        prompt = <<~PROMPT
          You are a professional translator. Translate the following schema headline to #{language.name} (#{language.html_lang}).
      ...
      def translate_custom_excerpt
        ...
        prompt = <<~PROMPT
          You are a professional translator. Translate the following article excerpt to #{language.name} (#{language.html_lang}).
