module Postnhost
  module Translation
    class ContentTranslator < BaseService
      ...
      def translate_title
        prompt = <<~PROMPT
          Translate this title into #{language.name} (#{language.html_lang}).
      ...
      def translate_og_title
        ...
        prompt = <<~PROMPT
          Translate this Open Graph title into #{language.name} (#{language.html_lang}).
      ...
      def translate_title_tag
        ...
        prompt = <<~PROMPT
          Translate this title tag into #{language.name} (#{language.html_lang}).
      ...
      def translate_meta_description
        ...
        prompt = <<~PROMPT
          Translate this meta description into #{language.name} (#{language.html_lang}).
      ...
      def translate_body
        prompt = <<~PROMPT
          Translate this content into #{language.name} (#{language.html_lang}).

          Requirements:
          - Maintain the exact HTML structure and formatting
          - Preserve the tone while using natural #{language.name}
